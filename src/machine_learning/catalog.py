...
def load_machine_learning_catalog() -> dict[str, Any]:
    """Load and normalise the machine-learning catalog JSON.
...
def list_standard_machine_learning_techniques() -> list[dict[str, Any]]:
    """Return standard-machine-learning techniques with prompt schemas.

    Returns:
        list[dict[str, Any]]: List of parsed values.
    """

    return list_tool_techniques("standard_machine_learning")


def list_longitudinal_machine_learning_techniques() -> list[dict[str, Any]]:
    """Return longitudinal-machine-learning techniques with prompt schemas.

    Returns:
        list[dict[str, Any]]: List of parsed values.
    """

    return list_tool_techniques("longitudinal_machine_learning")


def list_benchmark_standard_ml_techniques() -> list[dict[str, Any]]:
    """Return benchmark-standard-ml techniques with prompt schemas.

    Returns:
        list[dict[str, Any]]: List of parsed values.
    """

    return list_tool_techniques("benchmark_standard_ml")


def list_benchmark_longitudinal_ml_techniques() -> list[dict[str, Any]]:
    """Return benchmark-longitudinal-ml techniques with prompt schemas.

    Returns:
        list[dict[str, Any]]: List of parsed values.
    """

    return list_tool_techniques("benchmark_longitudinal_ml")


def list_bench_standard_and_longitudinal_ml_techniques() -> list[dict[str, Any]]:
    """Return mixed benchmark techniques with prompt schemas.

    Returns:
        list[dict[str, Any]]: List of parsed values.
    """

    return list_tool_techniques("bench_standard_and_longitudinal_ml")


def list_shap_analysis_techniques() -> list[dict[str, Any]]:
    """Return SHAP-analysis techniques with prompt schemas.

    Returns:
        list[dict[str, Any]]: List of parsed values.
    """

    return list_tool_techniques("shap_analysis")


def list_machine_learning_presets() -> list[dict[str, Any]]:
    """Return machine-learning reproducibility presets metadata.

    Returns:
        list[dict[str, Any]]: List of parsed values.
    """

    catalog = load_machine_learning_catalog()
...
def list_tool_techniques(section_key: str) -> list[dict[str, Any]]:
    """Return techniques for one machine-learning catalog section.
