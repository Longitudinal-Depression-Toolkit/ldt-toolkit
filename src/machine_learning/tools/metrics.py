...
def list_supported_metrics() -> tuple[MetricDefinition, ...]:
    """Return all supported metrics (scikit-learn + custom).

    This helper is used by higher-level workflows and keeps input/output handling consistent.

    Returns:
        tuple[MetricDefinition, ...]: Tuple of resolved values.
    """
...
def resolve_metric_definition(metric_key: str) -> MetricDefinition:
    ...
    Returns:
        MetricDefinition: Result object for this operation.
    """
