...
from src.machine_learning.tools.metrics import (
...
class ClassificationExperimentArtifacts:
    """Artifact paths produced by one classification experiment.
...
class ClassificationExperimentTemplate:
    ...
    def run(
        ...
        *,
        ...
        with Progress(
            ...
            progress.update(task_id, advance=1, description="Writing artifacts...")
    ...
    def _write_artifacts(
        *,
        ...
        Returns:
            ClassificationExperimentArtifacts: Saved artifact paths.
        """
