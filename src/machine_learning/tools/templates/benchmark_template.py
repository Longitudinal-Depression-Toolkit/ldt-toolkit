...
class BenchmarkEstimatorResult:
    ...
    Attributes:
        ...
        artifacts (ClassificationExperimentArtifacts): Artifacts.
...
class BenchmarkPipelineProfilerArtifacts:
    """PipelineProfiler compatibility artifacts.
...
class ClassificationBenchmarkResult:
    ...
    Attributes:
        ...
        artifacts (ClassificationBenchmarkArtifacts): Artifacts.
...
class ClassificationBenchmarkTemplate:
    ...
    def resolve_pipeline_profiler_payload_path(*, input_path: Path) -> Path:
        """Resolve a PipelineProfiler payload path from benchmark artifacts.
        ...
        if not resolved.exists() or not resolved.is_file():
            raise InputValidationError(
                "Resolved PipelineProfiler input JSON does not exist: " f"{resolved}"
            )
        return resolved
    ...
    def run(
        ...
        *,
        ...
        with Progress(
            ...
            progress.update(
                task_id, description="Exporting PipelineProfiler artifacts..."
            )
    ...
    def _write_failed_estimator_artifacts(
        *,
        ...
        """Persist placeholder artifacts for failed estimators."""
