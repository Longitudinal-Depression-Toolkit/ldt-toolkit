...
class SepWavStackingDTDecisionTreeLongitudinalEstimatorTemplate(
    LongitudinalEstimatorTemplate
):
    """Template definition for `sepwav_stacking_dt__decision_tree` longitudinal estimator."""

    metadata = ComponentMetadata(
        name="sepwav_stacking_dt__decision_tree",
        full_name="SepWav (Stacking + Decision Tree) + Decision Tree",
